...
/**
 * 交易成交详情 @Version 1.0 @Since JDK1.8 @Author junxiaoyang @Company 洛阳艾鹿网络有限公司 @Date 12/01/2018 13:52
 */
@Data
public class Trade implements OnlyKey {

  @PointExt.Measurement private String measurement = "trade";

  private String tradeId; // 交易所成交 id
  @PointExt.Tag private String exchange; // 交易所
  @PointExt.Tag private String symbol; // 股票代码
  @PointExt.Tag private String unit; // 兑换货币单位
  ...
  @PointExt.Time private Long timestamp; // 成交时间毫秒
