...
public class Pairs implements OnlyKey {
  ...
  @PointExt.Measurement private String measurement = "pairs";
  ...
  // 交易所本项目枚举中的名称
  @PointExt.Tag private String exchange; // 交易所

  @PointExt.Tag private String symbol; // 币种

  @PointExt.Tag private String unit; // 单位

  /**
   * 这个币种在这个交易所所对应的货币单位 比如 coinMarketCode = ETH marketCode = huobipro currency = BTC 则onlykey为
   * Huobi_ETH_BTC
   */
  ...
  @PointExt.Time private Long timestamp;
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder(17, 37).appendSuper(super.hashCode()).append(onlyKey).toHashCode();
  }
}
