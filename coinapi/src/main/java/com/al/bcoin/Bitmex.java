...
/** NOTE: @Version 1.0 @Since JDK1.8 @Author mr.wang @Company 洛阳艾鹿网络有限公司 @Date 2018/7/25 15:46 */
@Data
public class Bitmex {
  ...
  public interface Api {
    ...
    Map<String, Integer> pairTypeMap =
    ...
    List<String> pairTypeNumList =
        Arrays.asList("F", "G", "H", "J", "K", "M", "N", "Q", "U", "V", "X", "Z");
  ...
  static Map<String, Api.BitmexPair> pairsMap =
      new HashMap<String, Api.BitmexPair>() {
        {
  ...
  public static String getMouthCode(String symbol) {
    ...
    LocalDate resultDate =
        LocalDate.of(
            lastDayByThisMonth.getYear(), resultInteger, lastDayByThisMonth.getDayOfMonth());
  ...
  public static Bitmex.Api bitmexApi =
  ...
  public static void main(String[] args) {
    try {
      bitmexApi.wsAll().message(info -> System.out.println(info)).start();
    } catch (IOException e) {
      e.printStackTrace();
    }
  }
