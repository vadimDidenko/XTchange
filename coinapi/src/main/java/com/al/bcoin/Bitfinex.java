...
public class Bitfinex {
  ...
  public interface Api {
     ...
     * volume and how much the price has moved over the last day. 30 req/min
     *
    ...
    Call<String> kline(
        @Path("tf") String timeFrame, @Path("symbol") String symbol, @Path("se") String section);

    default WSListener ws() {
      return new WSListener().url(WS_URL).parse(Bitfinex::paser);
    }
    ...
    List<String> defaultSymbols =
        Arrays.asList(
            ...
            "xrpusd", "xrpbtc", "iotusd", "iotbtc", "ioteth", "eosusd", "eosbtc", "eoseth",
            "sanusd", "sanbtc", "saneth", "omgusd", "omgbtc", "omgeth", "bchusd", "bchbtc",
            "bcheth", "neousd", "neobtc", "neoeth", "etpusd", "etpbtc", "etpeth", "qtmusd",
            "qtmbtc", "qtmeth", "avtusd", "avtbtc", "avteth", "edousd", "edobtc", "edoeth",
            "btgusd", "btgbtc", "datusd", "datbtc", "dateth", "qshusd", "qshbtc", "qsheth",
            "yywusd", "yywbtc", "yyweth", "gntusd", "gntbtc", "gnteth", "sntusd", "sntbtc",
            "snteth", "ioteur", "batusd", "batbtc", "bateth", "mnausd", "mnabtc", "mnaeth",
            "funusd", "funbtc", "funeth", "zrxusd", "zrxbtc", "zrxeth", "tnbusd", "tnbbtc",
            "tnbeth", "spkusd", "spkbtc", "spketh");
  ...
  public static void main(String[] args) {
    try {
      bitfinexApi.wsAll().message(info -> System.out.println("info:" + info)).start();
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
