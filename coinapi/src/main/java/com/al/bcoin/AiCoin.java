...
public class AiCoin {
  ...
  public interface Api {
    ...
    Call<List<String>> getHistoryKline(
     ...
     */
    default void getKlineAll(Integer step, KlineListener listener, Predicate<Coin> filter)
    ...
    /** 获取某个交易对所有历史K线 */
    default void getKlineByCoin(Coin coin, Integer step, KlineListener listener)
        throws IOException, InterruptedException {
  ...
  public static void main(String[] args) {
    try {
      KlineListener listener =
          (coin, kline) -> System.out.println("done! 交易对:" + coin + ",k线：" + kline);
