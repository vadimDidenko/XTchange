  ...
  public BitmexResult executeSync(final Call<?> call) {
    try {
      ...
      if (response.isSuccessful()) {
        ...
        bitmexResult.setXRateLimitRemaining(
            Long.valueOf(response.headers().get("x-ratelimit-remaining")));
  ...
  private void printResponse(final Response response) {
    ...
    if (response != null) {
      ...
      if (StringUtils.isNotEmpty(limit)) {
        ...
        responseInfo
            .append("\n\t\t\t")
            .append(HttpHeadersEnum.OK_BEFORE.header())
            .append(": ")
            .append(response.headers().get(HttpHeadersEnum.OK_BEFORE.header()));
        responseInfo
            .append("\n\t\t\t")
            .append(HttpHeadersEnum.OK_AFTER.header())
            .append(": ")
