...
//
//  public BitmexUserTrade(OrderType type, BigDecimal originalAmount, CurrencyPair currencyPair,
// BigDecimal price, Date timestamp, String id,
//                         String orderId, BigDecimal feeAmount, Currency feeCurrency, BigDecimal
// cost) {
//    super(type, originalAmount, currencyPair, price, timestamp, id, orderId, feeAmount,
// feeCurrency);
//    this.cost = cost;
//  }
//
...
//      BitmexUserTrade trade = new BitmexUserTrade(type, originalAmount, currencyPair, price,
// timestamp, id, orderId, feeAmount, feeCurrency, cost);
//      return trade;
//    }
//  }
//
