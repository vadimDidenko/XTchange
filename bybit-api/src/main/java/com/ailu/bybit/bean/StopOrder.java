...
public class StopOrder {
  ...
  /**
   * stop_order_id : string user_id : 0 户ID 'stop_order_status' : string symbol : string side :
   * string order_type : string price : 0 qty : 0 time_in_force : string stop_order_type : string
   * base_price : 0 stop_px : 0 order_link_id : string created_at : 2018-10-15T04:12:19.000Z
