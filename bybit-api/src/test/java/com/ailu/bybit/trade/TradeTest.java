...
//        TradeService tradeService = new TradeServiceImpl(new BybitClient(config()));
//        List<Order> orders = tradeService.getOrders("okef",
// "liujianshu","active","okef//eth.usd.q-20190109-103606-cqrnkbq670nbj6twm85sa20bxs1","okef//eth.usd.q-2114543081659393",null);
//        log.info(JSON.toJSONString(orders));
//    }
//
//    @Test
...
// JSON.parseObject("{\"bs\":\"b\",\"amount\":\"1\",\"price\":\"2\",\"contract\":\"okef/eth.usd.q\",\"options\":{\"close\":\"false\"},\"exchange\":\"okef\"}");
...
//        TradeService tradeService = new TradeServiceImpl(new BybitClient(config()));
//        JSONArray jsonArray = tradeService.cancelOrder("okef", "liujianshu",
// "okef/eth.usd.q-20181217-112304-c3nsh8168lq8wu5rwttx79movzc", null);
