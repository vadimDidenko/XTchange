 ...
 * open on the exchange. Note that both "algo" orders and normal orders are counted for this filter.
 *
 * <p>The MAX_ALGO_ORDERS filter defines the maximum number of "algo" orders an account is allowed
 * to have open on the exchange. "Algo" orders are STOP_LOSS, STOP_LOSS_LIMIT, TAKE_PROFIT, and
