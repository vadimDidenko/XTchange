...
/**
 * Tests that JSON responses from ta candlestick event are converted to the appropriate <code>
 * CandlestickEvent</code> object.
 */
  ...
  public void testCandlestickEventDeserializer() {
    ...
    try {
      CandlestickEvent candlestickEvent =
          mapper.readValue(candlestickEventJson, CandlestickEvent.class);
