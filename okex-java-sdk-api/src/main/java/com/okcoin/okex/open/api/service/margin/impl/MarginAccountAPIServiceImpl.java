...
public class MarginAccountAPIServiceImpl implements MarginAccountAPIService {
  ...
  @Override
  public List<UserMarginBillDto> getLedger(
  ...
  @Override
  public List<MarginBorrowOrderDto> getBorrowedAccounts(
      final String status, final String from, final String to, final String limit) {
    return this.client.executeSync(this.api.getBorrowedAccounts(status, from, to, limit));
  }

  @Override
  public List<MarginBorrowOrderDto> getBorrowedAccountsByProductId(
      final String product,
      final String from,
      final String to,
      final String limit,
    ...
    return this.client.executeSync(
        this.api.getBorrowedAccountsByProductId(product, from, to, limit, status));
  }
