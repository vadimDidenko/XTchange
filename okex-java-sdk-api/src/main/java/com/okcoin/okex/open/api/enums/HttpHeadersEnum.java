 ...
 * OKEX stores the salted hash of your passphrase for verification, but cannot recover the
 * passphrase if you forget it.<br>
 * OKEX cursor pagination response headers.<br>
 * Request page before (newer) and after (older) this pagination id, and limit number of results per
 * request. maximum 100. (default 100). <br>
 *
 * @author Tony Tian
 * @version 1.0.0
 * @date 2018/2/5 20:45
