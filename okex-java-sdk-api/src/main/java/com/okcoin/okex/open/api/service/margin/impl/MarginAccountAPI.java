...
public interface MarginAccountAPI {
  ...
  Call<List<UserMarginBillDto>> getLedger(
      @Path("instrument_id") final String product,
  ...
  Call<List<Map<String, Object>>> getAvailabilityByProductId(
      @Path("instrument_id") final String product);
  ...
  Call<List<MarginBorrowOrderDto>> getBorrowedAccountsByProductId(
      @Path("instrument_id") final String product,
      @Query("from") final String from,
      @Query("to") final String to,
