...
public class AccountAPIServiceImpl implements AccountAPIService {
  ...
  public JSONObject transfer(Transfer transfer) {
    return this.client.executeSync(
        this.api.transfer(JSONObject.parseObject(JSON.toJSONString(transfer))));
  }

  @Override
  public JSONObject withdraw(Withdraw withdraw) {
    return this.client.executeSync(
        this.api.withdraw(JSONObject.parseObject(JSON.toJSONString(withdraw))));
  }
  ...
  public List<Ledger> getLedger(
      Integer type, String currency, Integer before, Integer after, int limit) {
