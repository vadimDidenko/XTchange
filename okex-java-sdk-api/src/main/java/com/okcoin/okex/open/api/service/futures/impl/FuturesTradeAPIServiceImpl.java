...
public class FuturesTradeAPIServiceImpl implements FuturesTradeAPIService {
  ...
  public JSONObject cancelOrders(String instrumentId, CancelOrders cancelOrders) {
    return this.client.executeSync(
        this.api.cancelOrders(
            instrumentId, JsonUtils.convertObject(cancelOrders, CancelOrders.class)));
  }
  ...
  public JSONArray getFills(String instrumentId, long orderId, int from, int to, int limit) {
    return this.client.executeSync(
        this.api.getFills(instrumentId, String.valueOf(orderId), from, to, limit));
  }
  ...
  @Override
  public JSONObject changeLevelRate(
      String currency, String instrumentId, String direction, int leverage) {
    return this.client.executeSync(
        this.api.changeLevelRate(currency, instrumentId, direction, leverage));
  }
