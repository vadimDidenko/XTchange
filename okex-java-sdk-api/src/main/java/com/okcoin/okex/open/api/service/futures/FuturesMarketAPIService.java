...
public interface FuturesMarketAPIService {
   ...
   * @param granularity Time granularity measured in seconds. data after the timestamp will be
   *     returned 60 -> 1min 180 -> 3min 300 -> 5min 900 -> 15min 1800 -> 30min 3600 -> 1hour 7200
   *     -> 2hour 14400 -> 4hour 21600 -> 6hour 43200 -> 12hour 86400 -> 1day 604800 -> 1week
   */
   ...
   */
  List<Liquidation> getInstrumentLiquidation(
