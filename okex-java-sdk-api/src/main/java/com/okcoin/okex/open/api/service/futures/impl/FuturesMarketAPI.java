...
interface FuturesMarketAPI {
  ...
  Call<Book> getInstrumentBook(
      @Path("instrument_id") String instrumentId, @Query("size") Integer size);
  ...
  Call<List<Trades>> getInstrumentTrades(
  ...
  Call<JSONArray> getInstrumentCandles(
      @Path("instrument_id") String instrumentId,
  ...
  Call<List<Liquidation>> getInstrumentLiquidation(
      @Path("instrument_id") String instrumentId,
