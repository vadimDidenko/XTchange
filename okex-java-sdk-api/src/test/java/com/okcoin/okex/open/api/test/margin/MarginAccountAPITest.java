...
public class MarginAccountAPITest extends MarginAPIBaseTests {
  ...
  public void getAccountsByProductId() {
    final Map<String, Object> result =
        this.marginAccountAPIService.getAccountsByProductId("eth-usdt");
    this.toResultString(MarginAccountAPITest.LOG, "result", result);
  }
  ...
  public void getLedger() {
    final List<UserMarginBillDto> result =
        this.marginAccountAPIService.getLedger("EOS-USDT", "", null, null, null);
    this.toResultString(MarginAccountAPITest.LOG, "result", result);
  }
  ...
  public void getAvailabilityByProductId() {
    final List<Map<String, Object>> result =
        this.marginAccountAPIService.getAvailabilityByProductId("lTC-usdt");
    this.toResultString(MarginAccountAPITest.LOG, "result", result);
  }
  ...
  public void getBorrowedAccounts() {
    final List<MarginBorrowOrderDto> result =
        this.marginAccountAPIService.getBorrowedAccounts("0", null, null, "2");
    this.toResultString(MarginAccountAPITest.LOG, "result", result);
  }
  ...
  public void getBorrowedAccountsByProductId() {
    final List<MarginBorrowOrderDto> result =
        this.marginAccountAPIService.getBorrowedAccountsByProductId(
            "lTC_usdt", null, null, "2", "0");
    this.toResultString(MarginAccountAPITest.LOG, "result", result);
  }
  /** 借币 */
  @Test
