...
/**
 * <a
 * href="https://www.aex.com/page/api_detailed.html">https://www.aex.com/page/api_detailed.html</a>
 * <br>
...
public interface Aex {
  ...
  @GET("trades.php")
  Call<String> trade(
      @Query("c") String symbol, @Query("mk_type") String unit, @Query("tid") Long tid);
}
