...
public interface Poloniex {
  ...
  /**
   * command = returnTicker Returns the ticker for all markets.
   *
   * @param command
   * @return
   */
  ...
  @Headers(
      "user-agent:Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko)"
          + " Chrome/63.0.3239.26 Safari/537.36 Core/1.63.4694.400 QQBrowser/10.0.569.400")
  ...
  Call<String> getTradeHistory(
      ...
      @Query("currencyPair") String currencyPair,
