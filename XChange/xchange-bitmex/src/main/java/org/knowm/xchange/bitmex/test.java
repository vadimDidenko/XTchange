...
/** NOTE: @Version 1.0 @Since JDK1.8 @Author mr.wang @Company 洛阳艾鹿网络有限公司 @Date 2018/12/3 15:16 */
public class test {
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      ...
      List<BitmexMarginAccount> bitmexMarginAccountsStatus =
          accountService.getBitmexMarginAccountsStatus();
      System.out.println("accoutnStatus:" + JSON.toJSONString(bitmexMarginAccountsStatus));

      List<BitmexWalletTransaction> bitmexWalletHistory =
          accountService.getBitmexWalletHistory("0", "100", "true");
