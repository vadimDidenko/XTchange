...
public interface DSXAuthenticatedV2 extends DSX {
   ...
   *
   * <p>All parameters are obligatory (ie. none may be null)
   *
   ...
   * place fill-or-kill or market order, send any random number for rate param
   *
   * <p>All parameters, except rate param, are obligatory (ie. none may be null)
   *
