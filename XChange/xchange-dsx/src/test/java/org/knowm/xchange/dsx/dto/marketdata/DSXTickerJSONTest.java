...
public class DSXTickerJSONTest {
  ...
  public void testUnmarshall() throws IOException {
    ...
    assertThat(dsxTickerWrapper.getTicker(DSXAdapters.getPair(CurrencyPair.BTC_USD)).getHigh())
        .isEqualTo(new BigDecimal("109.88"));
    assertThat(dsxTickerWrapper.getTicker(DSXAdapters.getPair(CurrencyPair.BTC_USD)).getLow())
        .isEqualTo(new BigDecimal("91.14"));
    assertThat(dsxTickerWrapper.getTicker(DSXAdapters.getPair(CurrencyPair.BTC_USD)).getVol())
    ...
    String dateString =
        f.format(
            DateUtils.fromMillisUtc(
                dsxTickerWrapper.getTicker(DSXAdapters.getPair(CurrencyPair.BTC_USD)).getUpdated()
                    * 1000L));
