 ...
 *
 * <p>A floating rate loan order is a loan order whose rate is determined by the market. This type
 * of loan order can be preferable for creditors when loans have a callable provision (i.e. the
 * debtor can choose to pay off the loan early and acquire another loan at a more favorable rate).
 */
