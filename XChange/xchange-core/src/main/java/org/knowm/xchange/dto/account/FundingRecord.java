...
public final class FundingRecord implements Serializable {
   ...
   * @param externalId External Transaction id that identifies the transaction within the public
  ...
  public String toString() {
    return String.format(
        "FundingRecord{address='%s', date=%s, currency=%s, amount=%s, internalId=%s,"
            + " externalId=%s, description='%s', type=%s, status=%s, balance=%s, fee=%s}",
        address,
        date,
        currency,
        amount,
