 ...
 *   <li>{@link #abucoinsWithdraw POST withdrawals/crypto}
 *   <li>{@link #abucoinsCryptoDeposit POST deposits/crypto}
 *       <ol>
 *
...
public class AbucoinsAccountServiceRaw extends AbucoinsBaseService {
   ...
   * @throws IOException
   */
  public AbucoinsCryptoWithdrawal abucoinsWithdraw(AbucoinsCryptoWithdrawalRequest withdrawRequest)
      throws IOException {
    return abucoinsAuthenticated.cryptoWithdrawal(
        withdrawRequest,
        exchange.getExchangeSpecification().getApiKey(),
        signatureCreator,
        exchange.getExchangeSpecification().getPassword(),
   ...
   * @throws IOException
   */
  public AbucoinsCryptoDeposit abucoinsCryptoDeposit(AbucoinsCryptoDepositRequest cryptoRequest)
      throws IOException {
    return abucoinsAuthenticated.cryptoDeposit(
        cryptoRequest,
        exchange.getExchangeSpecification().getApiKey(),
        signatureCreator,
        exchange.getExchangeSpecification().getPassword(),
