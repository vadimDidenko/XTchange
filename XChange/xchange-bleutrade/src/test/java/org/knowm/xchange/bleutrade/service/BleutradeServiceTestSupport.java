...
public class BleutradeServiceTestSupport extends BleutradeTestData {
  ...
  protected static final String EXPECTED_BLEUTRADE_TICKER_STR =
      "Ticker [currencyPair=BLEU/BTC, last=0.00101977, bid=0.00100000, ask=0.00101977,"
          + " high=0.00105000, low=0.00086000,avg=0.00103455, volume=2450.97496015,"
          + " timestamp=1406632770000]";
  ...
  protected static String[] expectedBleutradeCurrenciesStr() {
    return new String[] {
      "BleutradeCurrency [Currency=BTC, CurrencyLong=Bitcoin, MinConfirmation=2, TxFee=0.00080000,"
          + " IsActive=true, CoinType=BITCOIN, additionalProperties={}]",
      "BleutradeCurrency [Currency=LTC, CurrencyLong=Litecoin, MinConfirmation=4,"
          + " TxFee=0.02000000, IsActive=true, CoinType=BITCOIN, additionalProperties={}]"
    };
  }
  ...
  protected static String[] expectedBleutradeMarketsStr() {
    return new String[] {
      "BleutradeMarket [MarketCurrency=DOGE, BaseCurrency=BTC, MarketCurrencyLong=Dogecoin,"
          ...
          + " IsActive=true, additionalProperties={}]",
      "BleutradeMarket [MarketCurrency=BLEU, BaseCurrency=BTC, MarketCurrencyLong=Bleutrade Share,"
          + " BaseCurrencyLong=Bitcoin, MinTradeSize=1E-8, MarketName=BLEU_BTC, IsActive=true,"
          + " additionalProperties={}]"
    };
  }
