...
public class BleutradeExtendedDtoTest extends BleutradeDtoTestSupport {
  ...
  protected static final String BALANCES_RETURN_STR =
      "BleutradeBalancesReturn [success=true, message=, result=[BleutradeBalance [Currency=DOGE,"
          ...
          + " additionalProperties={foo=1}], BleutradeBalance [Currency=BTC, Balance=15.49843675,"
          + " Available=13.98901996, Pending=0E-8,"
          + " CryptoAddress=1NKh9X1z4Q4AbBnEgNiKU177GMyeQUexC9, IsActive=true,"
          + " additionalProperties={bar=true}]], additionalProperties={ext=extended value}]";
  ...
  protected static final String DEPOSIT_ADDRESS_RETURN_STR =
      "BleutradeDepositAddressReturn [success=true, message=, result=BleutradeDepositAddress"
          + " [Currency=BTC, Address=1NKh9X1z4Q4AbBnEgNiKU177GMyeQUexC9,"
  ...
  protected static final String MARKET_HISTORY_RETURN_STR =
      "BleutradeMarketHistoryReturn [success=true, message=, result=[BleutradeTrade"
          ...
          + " Total=0.360234432, OrderType=BUY, additionalProperties={foo=1}], BleutradeTrade"
  ...
  protected static final String MARKETS_RETURN_STR =
      "BleutradeMarketsReturn [success=true, message=, result=[BleutradeMarket"
          ...
          + " IsActive=true, additionalProperties={foo=1}], BleutradeMarket [MarketCurrency=BLEU,"
          + " BaseCurrency=BTC, MarketCurrencyLong=Bleutrade Share, BaseCurrencyLong=Bitcoin,"
          + " MinTradeSize=1E-8, MarketName=BLEU_BTC, IsActive=true,"
          + " additionalProperties={bar=true}]], additionalProperties={ext=extended value}]";
  ...
  protected static final String OPEN_ORDERS_RETURN_STR =
      "BleutradeOpenOrdersReturn [success=true, message=, result=[BleutradeOpenOrder"
          ...
          + " id #123, additionalProperties={foo=1}], BleutradeOpenOrder [OrderId=65724,"
  ...
  protected static final String ORDER_BOOK_RETURN_STR =
      "BleutradeOrderBookReturn [success=true, message=, result=BleutradeOrderBookResult "
          ...
          + " additionalProperties={ext=1}], BleutradeLevel [Quantity=50.00000000,"
          + " Rate=3.50000000, additionalProperties={ext=2}]], sell=[BleutradeLevel"
          + " [Quantity=12.44147454, Rate=5.13540000, additionalProperties={ext=3}],"
          + " BleutradeLevel [Quantity=100.00000000, Rate=6.25500000,"
          + " additionalProperties={ext=4}], BleutradeLevel [Quantity=30.00000000,"
          + " Rate=6.75500001, additionalProperties={ext=5}], BleutradeLevel"
          + " [Quantity=13.49989999, Rate=6.76260099, additionalProperties={ext=6}]],"
          + " additionalProperties={foo=1}], additionalProperties={ext=extended value}]";
  ...
  protected static final String TICKER_RETURN_STR =
      "BleutradeTickerReturn [success=true, message=, result=[BleutradeTicker"
          ...
          + " additionalProperties={foo=1}], BleutradeTicker [MarketName=LTC_BTC,"
          + " PrevDay=0.00095000, High=0.01333000, Low=0.01167001, Last=0.01333000,"
          + " Average=0.01235000, Volume=14.46077245, BaseVolume=0.18765956, TimeStamp=2014-07-29"
          + " 11:48:02, Bid=0.01268311, Ask=0.01333000, IsActive=true,"
          + " additionalProperties={bar=true}]], additionalProperties={ext=extended value}]";
