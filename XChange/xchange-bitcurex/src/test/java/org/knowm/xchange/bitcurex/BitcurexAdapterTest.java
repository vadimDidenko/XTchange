...
public class BitcurexAdapterTest {
  ...
  public void testOrderAdapterWithDepth() throws IOException {
    ...
    List<LimitOrder> asks =
        BitcurexAdapters.adaptOrders(
            BitcurexDepth.getAsks(), CurrencyPair.BTC_EUR, OrderType.ASK, "");
  ...
  public void testAccountFundsAdapter() throws IOException {
    ...
    assertThat(
        wallet.getBalance(Currency.BTC).getTotal().compareTo(new BigDecimal("2.59033845")) == 0);
    assertThat(
        wallet.getBalance(Currency.EUR).getTotal().compareTo(new BigDecimal("6160.06838790")) == 0);
  }
  ...
  public void testAccountFundsPLNAdapter() throws IOException {
    ...
    assertThat(
        wallet.getBalance(Currency.BTC).getTotal().compareTo(new BigDecimal("2.59033845")) == 0);
    assertThat(
        wallet.getBalance(Currency.PLN).getTotal().compareTo(new BigDecimal("6160.06838790")) == 0);
  }
}
