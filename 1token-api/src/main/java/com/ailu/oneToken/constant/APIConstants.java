...
public class APIConstants {
  ...
  /**
   * All requests and responses are application/json content type and follow typical HTTP response
  ...
  public static final MediaType JSON =
      MediaType.parse(ContentTypeEnum.APPLICATION_JSON.contentType());
  ...
  public static final List<String> toStringTypeArray =
      Arrays.asList("class java.lang.Long", "class java.lang.Integer", "long", "int");
  public static final List<String> toStringTypeDoubleArray =
      Arrays.asList("class java.lang.Double", "double");

  public static final List<Integer> resultStatusArray = Arrays.asList(400, 401, 429, 500);
