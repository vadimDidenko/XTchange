...
public class WSListener extends WebSocketListener {
  ...
  private BiConsumer<WebSocket, String> event(String eventype) {
    return this.eventListener.getOrDefault(
        eventype, (ws, str) -> System.out.println(eventype + ":" + str));
  }
  ...
  public static class Info<T> {
    ...
    /**
     * account_symbol : null currency : eth amount : 0.1 from_address :
     * 0x1598f402c73f722a09006ba54c2d6cc6ce9a6eb2 target_address :
     * 0x38022036073b3781848fde3299e907f407e9e5b9 fee : 1.05E-4 address_tag : null
     * exchange_deposit_id : 0xed4c29dbd0b7d8b265d842db599f6e899f746d602cc82f5d37a45cd3b3d3bf51
     * status : success create_time : null last_update : 2018-12-26T07:07:43+08:00 exchange_update :
     * 2018-12-26T07:07:43+08:00 tags : {"deposit_type":null}
     */
